...
namespace Unit_7_Searching_OMDB_Lab.Models
{
    public class MovieDAL
    {
        public Movie GetMovieByTitle(string title)
        {
            string URL = $"http://www.omdbapi.com/?t={title}&apikey={Secret.apiKey}";
        ...
        {
            string URL1 = $"http://www.omdbapi.com/?t={title1}&apikey={Secret.apiKey}";
            ...
            string URL2 = $"http://www.omdbapi.com/?t={title2}&apikey={Secret.apiKey}";
            ...
            string URL3 = $"http://www.omdbapi.com/?t={title3}&apikey={Secret.apiKey}";
